...
export class Hand3D {
  ...
  constructor() {
    ...
    // มือต้องพอดีกับสัตว์ ไม่ใช่ใหญ่กว่า — ของเดิม 2.4 หน่วย เทียบกับ
    // สัตว์ 0.7–1.6 · กระท่อม 0.88 · คน 0.34 แปลว่ามือใหญ่กว่าคนเจ็ดเท่า
    // และใหญ่กว่าสัตว์ที่ควรเป็นตัวเอกของเกม ซึ่งทำให้สัดส่วนทั้งฉากอ่านไม่ออก
